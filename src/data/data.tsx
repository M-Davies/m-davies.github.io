...
export const heroData: Hero = {
  ...
  description: (
    <>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg"> I'm a Manchester based <strong className="text-stone-100">Security Consultant</strong> currently conducting offensive security activities against client systems and building educational resources for newcomers to the industry. In my free time time, you can catch me training in the gym, strumming my electric guitar or travelling across various European cities. </p>
    </>
  ),
  actions: [
    {
...
export const aboutData: About = {
  ...
  aboutItems: [
    ...
    {label: 'Interests', text: 'Computing, Music, Travelling', Icon: SparklesIcon},
    {label: 'Study', text: 'BSC with Honours', Icon: AcademicCapIcon},
    {label: 'Employment', text: 'Information Assurance Firm', Icon: OfficeBuildingIcon},
  ],
};
  ...
  testimonials: [
    {
      ...
      image: 'https://media.licdn.com/dms/image/C4E03AQEAaNEb13HBdg/profile-displayphoto-shrink_100_100/0/1532002790788?e=1683763200&v=beta&t=c2BxtUdu03JS-FmfWSfVswls5sPeGa9C7lLAFsb_JDQ',
    },
    {
      ...
      image: 'https://media.licdn.com/dms/image/C4D03AQElhp_CzkOpNg/profile-displayphoto-shrink_100_100/0/1572966642068?e=1683763200&v=beta&t=r44b6ICq08XZWgOuxhgmpV2HHRO2D7QikAnDiIzDwvg',
    },
    {
      ...
      image: 'https://media.licdn.com/dms/image/C4D03AQHFwVdTWSd7og/profile-displayphoto-shrink_100_100/0/1516280994584?e=1683763200&v=beta&t=IbssmRO2q6OeVEjf2cStTXPuyPzn-_9Eg_rzRGOeW0c',
    },
  ],
};
...
export const contact: ContactSection = {
  ...
  description: 'Please see my methods of contact below. I endevour to get back to you ASAP, usually within 24 hours:',
  items: [
    {
